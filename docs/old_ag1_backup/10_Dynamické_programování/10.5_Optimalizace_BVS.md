...
- Samotné hodnoty klíčů nejsou pro strukturu optimálního stromu podstatné. Bez újmy na obecnosti (BÚNO) tedy uvažujeme klíče $1, 2, \dots, n$.

<a id="def-bvs-opt"></a>
!!! Definition "[Definice problému (Histogramové vyvážení BVS)](#def-bvs-opt)"

    **Vstup:** Pole $n$ četností klíčů $p_1, \dots, p_n$.

    **Výstup:** Binární vyhledávací strom $T$ s prvky $1, 2, \dots, n$, který minimalizuje výraz:

    $$
    \sum_{i \in [n]} (h_T(i) \cdot p_i)
    $$

    kde $h_T(i)$ označuje hloubku prvku $i$ ve stromu $T$.
...
![bvs_optimal](../../docs/assets/10/bvs_1.png){style=display:block;margin-left:auto;margin-right:auto;max-width:500px}
![bvs_optimal](../../docs/assets/10/bvs_2.png){style=display:block;margin-left:auto;margin-right:auto;max-width:500px}
...
<a id="algo-10.10"></a>
!!! Algorithm "[Algoritmus 10.10 (BVSOPT_rec)](#algo-10.10)"
...
<a id="algo-10.11"></a>
!!! Algorithm "[Algoritmus 10.11 (BVSOPT)](#algo-10.11)"
