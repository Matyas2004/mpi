<a id="def-10.1"></a>
!!! Definition "[Definice 10.1 (Triangulace)](#def-10.1)"
...
![ukázka triangulace](../../docs/assets/10/triangulation_def.png)
...
<a id="def-10.2"></a>
!!! Definition "[Definice 10.2 (Vlastnosti triangulace)](#def-10.2)"
...
![ukázka triangulace](../../docs/assets/10/mtm_idea.png){style=display:block;margin-left:auto;margin-right:auto;height:250px}
...
<a id="algo-10.12"></a>
!!! Algorithm "[Algoritmus 10.12 (MtmRec)](#algo-10.12)"
...
![ukázka principu_iterace](../../docs/assets/10/mtm_iter_1.png)
{style=display:block;margin-left:auto;margin-right:auto;max-width:600px}
...
![ukázka principu_iterace](../../docs/assets/10/mtm_iter_2.png)
{style=display:block;margin-left:auto;margin-right:auto;max-width:600px}
