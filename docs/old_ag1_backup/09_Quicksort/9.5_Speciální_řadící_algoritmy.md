...
<a id="def-9.5"></a>
!!! Definition "[Definice 9.5 (Porovnávací model RAM)](#def-9.5)"

    ### Porovnávací model RAM {#def-9.5}

    Porovnávací model RAM je stejný, jako normální model RAM, s omezením, že prvky na vstupu můžeme pouze porovnávat s ostatními prvky ze vstupu (deterministická binární operace $\lt, \gt, =$) a přesouvat. S daty, která jsme na vstupu nedostali si můžeme dělat cokoliv, co nám dovolí standardní model RAM.
...
![Image title](../../docs/assets/09/lexcountingsort.png){ align=center }
/// caption
Příklad běhu algoritmu LexCountingSort
///
...
<a id="theorem-9.6"></a>
!!! Theorem "[Věta 9.6 (o korektnosti algoritmu LexCountingSort)](#theorem-9.6)"
