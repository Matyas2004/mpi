...
![Image title](../../docs/assets/09/quicksort_complexity02.png){ align=center }
/// caption
...
<a id="theorem-9.1"></a>
!!! Theorem "[Věta 9.1 (o složitosti QuickSortu s náhodnou volbou pivota)](#theorem-9.1)"
...
!!! Definition "[Definice 9.1 (Indikátory)](#definition-9.1)"
...
<a id="proof-9.1"></a>
!!! Theorem "[Důkaz věty o analýze QuickSortu](#proof-9.1)"
...
<a id="theorem-9.3"></a>
!!! Theorem "[Věta 9.3 (o střední hodnotě počtu operací quicksortu)](#theorem-9.3)"
