...
![Image title](../../docs/assets/06/binary_tree_diagram.png){ align=center }
/// caption
...
<a id="def-6.1"></a>
!!! Definition "[Definice 6.1 (Binární vyhledávací strom)](#def-6.1)"
...
![Image title](../../docs/assets/06/bst_example.png){ align=center }
/// caption
Příklady BVS
///
