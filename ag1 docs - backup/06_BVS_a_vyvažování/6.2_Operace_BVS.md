...
<a id="algo-6.1"></a>
!!! Algorithm "[Algoritmus 6.1 (BVSShow)](#algo-6.1)"
...
<a id="algo-6.2"></a>
!!! Algorithm "[Algoritmus 6.2 (BVSMin)](#algo-6.2)"
...
<a id="algo-6.3"></a>
!!! Algorithm "[Algoritmus 6.3 (BVSPred)](#algo-6.3)"
...
<a id="algo-6.4"></a>
!!! Algorithm "[Algoritmus 6.4 (BVSFind)](#algo-6.4)"
...
<a id="algo-6.5"></a>
!!! Algorithm "[Algoritmus 6.5 (BVSInsert)](#algo-6.5)"
...
![Image title](../../docs/assets/06/bst_linear.png){ align=center }
/// caption
Tvar BVS
///
...
![Image title](../../docs/assets/06/bst_delete_leaf.png){ align=center }
/// caption
...
![Image title](../../docs/assets/06/bst_delete_child.png){ align=center }
/// caption
...
![Image title](../../docs/assets/06/bst_delete_children.png){ align=center }
/// caption
Odstranění vrcholu se dvěma syny
///

<a id="algo-6.6"></a>
!!! Algorithm "[Algoritmus 6.6 (BVSDelete)](#algo-6.6)"
