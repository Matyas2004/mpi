...
<a id="def-6.3"></a>
!!! Definition "[Definice 6.3 (Hloubkově vyvážený BVS)](#def-6.3)"
...
<a id="theorem-6.2"></a>
!!! Theorem "[Věta 6.2 (o hloubce hloubkově vyvážených stromů)](#theorem-6.2)"
...
![Image title](../../docs/assets/06/avl_rotate_right.png){ align=center }
/// caption
...
![Image title](../../docs/assets/06/avl_rotate_left.png){ align=center }
/// caption
Jednoduchá rotace doleva v AVL stromu
///

<a id="algo-6.7"></a>
!!! Algorithm "[Algoritmus 6.7 (rotateLeft)](#algo-6.7)"
...
![Image title](../../docs/assets/06/avl_rotate_double_needed.png){ align=center }
...
![Image title](../../docs/assets/06/avl_rotate_lr.png){ align=center }
/// caption
LR rotace
///
...
![Image title](../../docs/assets/06/avl_rotate_rl.png){ align=center }
/// caption
RL rotace
///
