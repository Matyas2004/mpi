...
<a id="algo-5.1"></a>
!!! Algorithm "[Algoritmus 5.1 (BHMergeTree)](#algo-5.1)"
...
![Image title](../../docs/assets/05/bh_merge_tree.png){ align=center }
...
![Image title](../../docs/assets/05/bh_binary_sum.png){ align=center }
...
![Image title](../../docs/assets/05/bh_binary_sum2.png){ align=center }

---

<a id="algo-5.2"></a>
!!! Algorithm "[Algoritmus 5.2 (BHMerge)](#algo-5.2)"
...
<a id="theorem-5.5"></a>
!!! Theorem "[Věta 5.5 (o korektnosti a složitosti algoritmu BHMerge)](#theorem-5.5)"
...
<a id="algo-5.3"></a>
!!! Algorithm "[Algoritmus 5.3 (BHInsert)](#algo-5.3)"
...
![Image title](../../docs/assets/05/bh_insert.png){ align=center }

---

<a id="theorem-5.6"></a>
!!! Theorem "[Věta 5.6 (o složitosti algoritmu BHInsert)](#theorem-5.6)"
...
<a id="algo-5.4"></a>
!!! Algorithm "[Algoritmus 5.4 (BHExtractMin)](#algo-5.4)"
...
![Image title](../../docs/assets/05/bh_extract_min_1.png){ align=center }
![Image title](../../docs/assets/05/bh_extract_min_2.png){ align=center }
![Image title](../../docs/assets/05/bh_extract_min_3.png){ align=center }
![Image title](../../docs/assets/05/bh_extract_min_4.png){ align=center }
![Image title](../../docs/assets/05/bh_extract_min_5.png){ align=center }

---

<a id="theorem-5.7"></a>
!!! Theorem "[Věta 5.7 (o složitosti algoritmu BHExtractMin)](#theorem-5.7)"
