<a id="def-5.3"></a>
!!! Definition "[Definice 5.3 (Binomiální halda)](#def-5.3)"
...
![Image title](../../docs/assets/05/binomial_heap1.png){ align=center }
...
<a id="theorem-5.4"></a>
!!! Theorem "[Věta 5.4 (o existenci stromu $B_{i}$ v BH)](#theorem-5.4)"
...
![Image title](../../docs/assets/05/binomial_heap2.png){ align=center }
