...
<a id="algo-8.4"></a>
!!! Algorithm "[8.4 QuickSelect](#algo-8.4)"
...
![Image title](../../docs/assets/08/skoromediany.png){ align=center }
...
<a id="algo-8.5"></a>
!!! Algorithm "[8.5 RandomQuickSelect](#algo-8.5)"
...
<a id="theorem-8.5"></a>
!!! Theorem "[Věta 8.5 Časová složitost RandomQuickSelect](#theorem-8.5)"
